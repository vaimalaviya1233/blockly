...
Blockly.Msg["CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK"] = "لوپ سے باہر نکلنا";
Blockly.Msg["CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE"] = "continue with next iteration of loop";  // untranslated
Blockly.Msg["CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK"] = "مشتمل لوپ کے باہر توڑ.";
...
Blockly.Msg["CONTROLS_FLOW_STATEMENTS_WARNING"] = "انتباہ: اس بلاک کو صرف لوپ میں استعمال کیا جاسکتا ہے۔";
Blockly.Msg["CONTROLS_FOREACH_HELPURL"] = "https://github.com/google/blockly/wiki/Loops#for-each";  // untranslated
Blockly.Msg["CONTROLS_FOREACH_TITLE"] = "प्रत्येक چیز کیلئے %1 فہرست ميں %2";
Blockly.Msg["CONTROLS_FOREACH_TOOLTIP"] = "فہرست میں ہر آئٹم کے لئے، '%1' متغیر کو آئٹم پہ لگائے،اور پھر کچھ جملے کہے";
Blockly.Msg["CONTROLS_FOR_HELPURL"] = "https://github.com/google/blockly/wiki/Loops#count-with";  // untranslated
Blockly.Msg["CONTROLS_FOR_TITLE"] = "%1 سے %2 سے %3 تک %4 کے ساتھ گنتی کریں";
Blockly.Msg["CONTROLS_FOR_TOOLTIP"] = "کیا چر '%1' ابتدا عدد سے اختتام عدد تک मानों کو لیتا ہے، निर्दिष्ट अंतराल کے تحت گنتی کرتا ہے، اور निर्दिष्ट रुकावटों کو کرتا ہے۔";
...
Blockly.Msg["CONTROLS_IF_TOOLTIP_1"] = "اگر ایک ویلیو صحیح ہے، تو کچھ سٹیٹمنٹ کریں";
...
Blockly.Msg["CONTROLS_REPEAT_TITLE"] = "%1 مرتبہ دہرائے";
Blockly.Msg["CONTROLS_REPEAT_TOOLTIP"] = "کچھ جملوں کو کہیں مرتبہ کریں۔";
Blockly.Msg["CONTROLS_WHILEUNTIL_HELPURL"] = "https://github.com/google/blockly/wiki/Loops#repeat";  // untranslated
Blockly.Msg["CONTROLS_WHILEUNTIL_OPERATOR_UNTIL"] = "تک دہرائے";
Blockly.Msg["CONTROLS_WHILEUNTIL_OPERATOR_WHILE"] = "کے دوران دہرائے";
Blockly.Msg["CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL"] = "اگر ایک ویلیو صحیح ہے، تو کچھ سٹیٹمنٹ کریں";
Blockly.Msg["CONTROLS_WHILEUNTIL_TOOLTIP_WHILE"] = "اگر ایک ویلیو صحیح ہے، تو کچھ سٹیٹمنٹ کریں";
...
Blockly.Msg["LISTS_CREATE_WITH_INPUT_WITH"] = "کے ساتھ فہرست بنائیں";
...
Blockly.Msg["LISTS_GET_INDEX_FIRST"] = "پہلا";
Blockly.Msg["LISTS_GET_INDEX_FROM_END"] = "آخر سے";
Blockly.Msg["LISTS_GET_INDEX_FROM_START"] = "#";  // untranslated
Blockly.Msg["LISTS_GET_INDEX_GET"] = "حاصل کریں";
...
Blockly.Msg["LISTS_GET_INDEX_REMOVE"] = "حذف کریں";
Blockly.Msg["LISTS_GET_INDEX_TAIL"] = "";  // untranslated
Blockly.Msg["LISTS_GET_INDEX_TOOLTIP_GET_FIRST"] = "پہلے آئٹم کو فہرست میں لوٹائے";
...
Blockly.Msg["LISTS_INLIST"] = "فہرست میں";
...
Blockly.Msg["LOGIC_NEGATE_TITLE"] = "%1 نہیں";
...
Blockly.Msg["LOGIC_TERNARY_IF_FALSE"] = "اگر غلط ہے";
Blockly.Msg["LOGIC_TERNARY_IF_TRUE"] = "اگ سچ ہے";
...
Blockly.Msg["NEW_COLOUR_VARIABLE"] = "رنگ متغیر بنائیں";
Blockly.Msg["NEW_NUMBER_VARIABLE"] = "عدد متغیر بناییں";
...
Blockly.Msg["PROCEDURES_DEFNORETURN_TITLE"] = "کو";
Blockly.Msg["PROCEDURES_DEFNORETURN_TOOLTIP"] = "بغیر آوٹ پٹ کا فنکشن بنائیں";
Blockly.Msg["PROCEDURES_DEFRETURN_HELPURL"] = "https://en.wikipedia.org/wiki/Subroutine";  // untranslated
Blockly.Msg["PROCEDURES_DEFRETURN_RETURN"] = "واپس آ جائیں";
Blockly.Msg["PROCEDURES_DEFRETURN_TOOLTIP"] = "بغیر آوٹ پٹ کا فنکشن بنائیں";
