...
Blockly.Msg["ADD_COMMENT"] = "Lasseet komment";
Blockly.Msg["CANNOT_DELETE_VARIABLE_PROCEDURE"] = "Ij lah máhđulâš sikkođ muttojeijee '%1' tanen ko tot lii uási funktio miäruštâllâm '%2'";
Blockly.Msg["CHANGE_VALUE_TITLE"] = "Mute áárvu:";
Blockly.Msg["CLEAN_UP"] = "Čurgii loigâttuvâid";
Blockly.Msg["COLLAPSED_WARNINGS_WARNING"] = "Collapsed blocks contain warnings.";  // untranslated
Blockly.Msg["COLLAPSE_ALL"] = "Toopâ loigâttuvâid";
Blockly.Msg["COLLAPSE_BLOCK"] = "Toopâ loigâttuv";
Blockly.Msg["COLOUR_BLEND_COLOUR1"] = "ivne 1";
Blockly.Msg["COLOUR_BLEND_COLOUR2"] = "ivne 2";
Blockly.Msg["COLOUR_BLEND_HELPURL"] = "https://meyerweb.com/eric/tools/color-blend/#:::rgbp";  // untranslated
Blockly.Msg["COLOUR_BLEND_RATIO"] = "koskâvuotâ";
Blockly.Msg["COLOUR_BLEND_TITLE"] = "siävuttâs";
Blockly.Msg["COLOUR_BLEND_TOOLTIP"] = "Siävvut kyevti ivne koskânis adelum koskâvuođâst (0.0 - 1.0).";
Blockly.Msg["COLOUR_PICKER_HELPURL"] = "https://smn.wikipedia.org/wiki/Ivne";
Blockly.Msg["COLOUR_PICKER_TOOLTIP"] = "Valjii ivne paletist.";
Blockly.Msg["COLOUR_RANDOM_HELPURL"] = "http://randomcolour.com";  // untranslated
Blockly.Msg["COLOUR_RANDOM_TITLE"] = "säti-ivne";
Blockly.Msg["COLOUR_RANDOM_TOOLTIP"] = "Valjii ivne sätioornigist.";
Blockly.Msg["COLOUR_RGB_BLUE"] = "čuovjâd";
Blockly.Msg["COLOUR_RGB_GREEN"] = "ruánáá";
Blockly.Msg["COLOUR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";  // untranslated
Blockly.Msg["COLOUR_RGB_RED"] = "ruopsâd";
Blockly.Msg["COLOUR_RGB_TITLE"] = "ivne, mast lii";
Blockly.Msg["COLOUR_RGB_TOOLTIP"] = "Räähti ivne, mast lii tiätu meeri ruopsâd, ruánáá já čuovjâd. Puoh áárvuh kalgeh leđe 0 já 100 kooskâst.";
...
Blockly.Msg["CONTROLS_IF_ELSEIF_TOOLTIP"] = "Lasseet iävtu \"jis\"-loigâttâhân.";
...
Blockly.Msg["CONTROLS_IF_MSG_ELSE"] = "mudoi";
Blockly.Msg["CONTROLS_IF_MSG_ELSEIF"] = "mudoi jis";
Blockly.Msg["CONTROLS_IF_MSG_IF"] = "jis";
...
Blockly.Msg["CONTROLS_REPEAT_INPUT_DO"] = "poorgâ";
Blockly.Msg["CONTROLS_REPEAT_TITLE"] = "kiärdut %1 tove";
Blockly.Msg["CONTROLS_REPEAT_TOOLTIP"] = "Do some statements several times.";  // untranslated
Blockly.Msg["CONTROLS_WHILEUNTIL_HELPURL"] = "https://github.com/google/blockly/wiki/Loops#repeat";  // untranslated
Blockly.Msg["CONTROLS_WHILEUNTIL_OPERATOR_UNTIL"] = "kiärdut tassaaš ko";
Blockly.Msg["CONTROLS_WHILEUNTIL_OPERATOR_WHILE"] = "kiärdut ton puudâ ko";
...
Blockly.Msg["DELETE_ALL_BLOCKS"] = "Siho puoh %1 loigâttuv?";
Blockly.Msg["DELETE_BLOCK"] = "Siho loigâttuv";
Blockly.Msg["DELETE_VARIABLE"] = "Siho muttojeijee '%1'";
Blockly.Msg["DELETE_VARIABLE_CONFIRMATION"] = "Sikkop-uv %1 kevttim muttojeijeest '%2'?";
Blockly.Msg["DELETE_X_BLOCKS"] = "Siho %1 loigâttuv";
Blockly.Msg["DIALOG_CANCEL"] = "Jooskâ";
Blockly.Msg["DIALOG_OK"] = "OK";
Blockly.Msg["DISABLE_BLOCK"] = "Časkâd loigâttuv";
Blockly.Msg["DUPLICATE_BLOCK"] = "Jyemeehpittá";
...
Blockly.Msg["LISTS_CREATE_WITH_INPUT_WITH"] = "räähti listo";
...
Blockly.Msg["LISTS_GET_INDEX_FIRST"] = "vuosmuš";
...
Blockly.Msg["LISTS_GET_INDEX_LAST"] = "majemuš";
Blockly.Msg["LISTS_GET_INDEX_RANDOM"] = "sätinálásâš";
Blockly.Msg["LISTS_GET_INDEX_REMOVE"] = "siho";
...
Blockly.Msg["LISTS_INLIST"] = "listoost";
Blockly.Msg["LISTS_ISEMPTY_HELPURL"] = "https://github.com/google/blockly/wiki/Lists#is-empty";  // untranslated
Blockly.Msg["LISTS_ISEMPTY_TITLE"] = "%1 lii kuárus";
Blockly.Msg["LISTS_ISEMPTY_TOOLTIP"] = "Returns true if the list is empty.";  // untranslated
Blockly.Msg["LISTS_LENGTH_HELPURL"] = "https://github.com/google/blockly/wiki/Lists#length-of";  // untranslated
Blockly.Msg["LISTS_LENGTH_TITLE"] = "%1 kukkodâh";
...
Blockly.Msg["LISTS_SORT_TITLE"] = "šlajâttâl %1 %2 %3";
...
Blockly.Msg["LOGIC_TERNARY_CONDITION"] = "testâ";
Blockly.Msg["LOGIC_TERNARY_HELPURL"] = "https://en.wikipedia.org/wiki/%3F:";  // untranslated
Blockly.Msg["LOGIC_TERNARY_IF_FALSE"] = "jis epituotâ";
Blockly.Msg["LOGIC_TERNARY_IF_TRUE"] = "jis tuotâ";
...
Blockly.Msg["MATH_CHANGE_TITLE"] = "mute %1 árvoin %2";
Blockly.Msg["MATH_CHANGE_TOOLTIP"] = "Lasseet áárvu muttojeijen '%1'.";
...
Blockly.Msg["MATH_IS_DIVISIBLE_BY"] = "puáhtá jyehiđ lovvoin";
Blockly.Msg["MATH_IS_EVEN"] = "lii parâlâš";
Blockly.Msg["MATH_IS_NEGATIVE"] = "lii negatiivlâš";
Blockly.Msg["MATH_IS_ODD"] = "lii parâttem";
Blockly.Msg["MATH_IS_POSITIVE"] = "lii positiivlâš";
Blockly.Msg["MATH_IS_PRIME"] = "lii algâloho";
Blockly.Msg["MATH_IS_TOOLTIP"] = "Täärhist lii-uv nummeer parâlâs, parâttem, algâloho, olesloho, positiivlâš, negatiivlâš, teikkâ jis tom puáhtá jyehiđ nube lovvoin. Maaccât tuotâ teikkâ epituotâ.";
Blockly.Msg["MATH_IS_WHOLE"] = "lii olesloho";
...
Blockly.Msg["MATH_NUMBER_TOOLTIP"] = "Loho.";
Blockly.Msg["MATH_ONLIST_HELPURL"] = "";  // untranslated
Blockly.Msg["MATH_ONLIST_OPERATOR_AVERAGE"] = "koskâárvu lovoin";
Blockly.Msg["MATH_ONLIST_OPERATOR_MAX"] = "stuárráámus lovoin";
Blockly.Msg["MATH_ONLIST_OPERATOR_MEDIAN"] = "mediaan lovoin";
Blockly.Msg["MATH_ONLIST_OPERATOR_MIN"] = "ucemus lovoin";
...
Blockly.Msg["MATH_ONLIST_OPERATOR_SUM"] = "summe lovoin";
Blockly.Msg["MATH_ONLIST_TOOLTIP_AVERAGE"] = "Maaccât aritmaattisâš koskâáárvu adelum lovoin.";
Blockly.Msg["MATH_ONLIST_TOOLTIP_MAX"] = "Maaccât stuárráámuu adelum lovoin.";
Blockly.Msg["MATH_ONLIST_TOOLTIP_MEDIAN"] = "Maaccât adelum lovoi mediaan.";
Blockly.Msg["MATH_ONLIST_TOOLTIP_MIN"] = "Maaccât ucemuu adelum lovoin.";
...
Blockly.Msg["MATH_ONLIST_TOOLTIP_SUM"] = "Maaccât puoh adelum lovoi sume.";
...
Blockly.Msg["MATH_ROUND_OPERATOR_ROUND"] = "jurbii";
Blockly.Msg["MATH_ROUND_OPERATOR_ROUNDDOWN"] = "jurbii vuáluskulij";
Blockly.Msg["MATH_ROUND_OPERATOR_ROUNDUP"] = "jurbii pajaskulij";
Blockly.Msg["MATH_ROUND_TOOLTIP"] = "Jorbee lovo pajas- teikkâ vuáluskulij.";
Blockly.Msg["MATH_SINGLE_HELPURL"] = "https://en.wikipedia.org/wiki/Square_root";  // untranslated
Blockly.Msg["MATH_SINGLE_OP_ABSOLUTE"] = "jiešárvu";
Blockly.Msg["MATH_SINGLE_OP_ROOT"] = "neljihâšruotâs";
...
Blockly.Msg["NEW_COLOUR_VARIABLE"] = "Räähti ivnemuttojeijee...";
Blockly.Msg["NEW_NUMBER_VARIABLE"] = "Räähti nummeermuttojeijee...";
Blockly.Msg["NEW_STRING_VARIABLE"] = "Räähti merkkâráiđumuttojeijee...";
Blockly.Msg["NEW_VARIABLE"] = "Räähti muttojeijee...";
Blockly.Msg["NEW_VARIABLE_TITLE"] = "Uđđâ muttojeijee nommâ:";
Blockly.Msg["NEW_VARIABLE_TYPE_TITLE"] = "Uđđâ muttojeijee tijppâ:";
Blockly.Msg["ORDINAL_NUMBER_SUFFIX"] = "";  // untranslated
Blockly.Msg["PROCEDURES_ALLOW_STATEMENTS"] = "allow statements";  // untranslated
Blockly.Msg["PROCEDURES_BEFORE_PARAMS"] = "parameettereh:";
...
Blockly.Msg["PROCEDURES_DEFNORETURN_PROCEDURE"] = "poorgâ maidnii";
Blockly.Msg["PROCEDURES_DEFNORETURN_TITLE"] = "to";  // untranslated
Blockly.Msg["PROCEDURES_DEFNORETURN_TOOLTIP"] = "Räähti puáđushánnáá leijee funktio.";
Blockly.Msg["PROCEDURES_DEFRETURN_HELPURL"] = "https://en.wikipedia.org/wiki/Subroutine";  // untranslated
Blockly.Msg["PROCEDURES_DEFRETURN_RETURN"] = "maaccât";
...
Blockly.Msg["PROCEDURES_MUTATORARG_TITLE"] = "fáálus nommâ:";
Blockly.Msg["PROCEDURES_MUTATORARG_TOOLTIP"] = "Add an input to the function.";  // untranslated
Blockly.Msg["PROCEDURES_MUTATORCONTAINER_TITLE"] = "fáluseh";
Blockly.Msg["PROCEDURES_MUTATORCONTAINER_TOOLTIP"] = "Add, remove, or reorder inputs to this function.";  // untranslated
Blockly.Msg["REDO"] = "Räähti uđđâsist";
Blockly.Msg["REMOVE_COMMENT"] = "Siho komment";
Blockly.Msg["RENAME_VARIABLE"] = "Noomât uđđâsist muttojeijee...";
Blockly.Msg["RENAME_VARIABLE_TITLE"] = "Noomât uđđâsist puoh '%1' muttojeijee:";
...
Blockly.Msg["TEXT_CREATE_JOIN_TITLE_JOIN"] = "labde";
...
Blockly.Msg["TEXT_PRINT_TITLE"] = "printtii %1";
...
Blockly.Msg["TODAY"] = "Onne";
Blockly.Msg["UNDO"] = "Koomeet";
Blockly.Msg["UNNAMED_KEY"] = "nomâttem";
Blockly.Msg["VARIABLES_DEFAULT_NAME"] = "tiŋgâ";
...
Blockly.Msg["VARIABLE_ALREADY_EXISTS"] = "Muttojeijee mon nommâ lii '%1' lii jo lemin.";
Blockly.Msg["VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE"] = "Muttojeijee, mon nommâ lii '%1', lii jo lemin nube tiijpân: '%2'.";
